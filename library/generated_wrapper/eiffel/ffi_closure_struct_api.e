...
feature {NONE} -- Implementation wrapper for struct ffi_closure
	...
	set_c_cif (an_item: POINTER; a_value: POINTER) 
		...
		alias
			"[
				((ffi_closure*)$an_item)->cif =  (ffi_cif*)$a_value
			]"
		ensure
	...
	set_c_fun (an_item: POINTER; a_value: POINTER) 
		...
		alias
			"[
				((ffi_closure*)$an_item)->fun =  (void (*) (ffi_cif *anonymous_1, void *anonymous_2, void **anonymous_3, void *anonymous_4))$a_value
			]"
		ensure
	...
	set_c_user_data (an_item: POINTER; a_value: POINTER) 
		...
		alias
			"[
				((ffi_closure*)$an_item)->user_data =  (void*)$a_value
			]"
		ensure
