...
class FFI_RAW_CLOSURE_STRUCT_API
...
feature {NONE} -- Implementation wrapper for struct ffi_raw_closure

	sizeof_external: INTEGER 
		external
			"C inline use <ffi.h>"
		alias
			"sizeof(ffi_raw_closure)"
		end
	...
	set_c_cif (an_item: POINTER; a_value: POINTER) 
		...
		alias
			"[
				((ffi_raw_closure*)$an_item)->cif =  (ffi_cif*)$a_value
			]"
		ensure
	...
	c_translate_args (an_item: POINTER): POINTER
		...
		alias
			"[
				((ffi_raw_closure*)$an_item)->translate_args
			]"
		end
	...
	set_c_translate_args (an_item: POINTER; a_value: POINTER) 
		...
		alias
			"[
				((ffi_raw_closure*)$an_item)->translate_args =  (void (*) (ffi_cif *anonymous_1, void *anonymous_2, void **anonymous_3, void *anonymous_4))$a_value
			]"
		ensure
	...
	c_this_closure (an_item: POINTER): POINTER
		...
		alias
			"[
				((ffi_raw_closure*)$an_item)->this_closure
			]"
		end
	...
	set_c_this_closure (an_item: POINTER; a_value: POINTER) 
		...
		alias
			"[
				((ffi_raw_closure*)$an_item)->this_closure =  (void*)$a_value
			]"
		ensure
	...
	set_c_fun (an_item: POINTER; a_value: POINTER) 
		...
		alias
			"[
				((ffi_raw_closure*)$an_item)->fun =  (void (*) (ffi_cif *anonymous_1, void *anonymous_2, ffi_raw *anonymous_3, void *anonymous_4))$a_value
			]"
		ensure
	...
	c_user_data (an_item: POINTER): POINTER
		...
		alias
			"[
				((ffi_raw_closure*)$an_item)->user_data
			]"
		end
	...
	set_c_user_data (an_item: POINTER; a_value: POINTER) 
		...
		alias
			"[
				((ffi_raw_closure*)$an_item)->user_data =  (void*)$a_value
			]"
		ensure
